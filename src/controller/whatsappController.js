...
export class WhatsappController {
    ...
    initAuth() {
        ...
        this.firebase.initAuth().then(response => {
            ...
            this._user.on('datachange', data => {
                ...
                this._user.photo = data.photo;

                this._user.passValues(data);
                        ...
                        <div class="_itDl">
                            ...
                            <span class="_2_LEW last-message">
                                ...
                                <div class="_3Bxar">
                                    <span>
                                        <div class="_15G96">
                                            <span class="OUeyt messages-count-new" style="display:none;">${contact.lastMessage}</span>
                                        </div>
                                </span></div>
                                </span>
                        </div>
    ...
    iniEvents() {
        ...
        this.el.inputDocument.on('change', e => {
            if (this.el.inputDocument.files.length) {
                ...
                this._documentProviewController.getPreviewData().then(data => {
        ...
        this.el.panelEmojis.querySelectorAll('.emojik').forEach(emoji => {
            emoji.on('click', () => {
                ...
                //cloneNode() é um metodo que copia o elemento que o chama e o retorna
                ...
                emoji.classList.forEach(classItem => {
                    img.classList.add(classItem);
                })

                let cursor = window.getSelection();
                //cria um manipulador de cursor para que seja possivel adicionar emojis
                ...
                //range é um intervalo de strings e possui varios métodos que as manipulam

                range = cursor.getRangeAt(0);
                //obtem o intervalo de strings definido pelo cursor

                range.deleteContents();
                //deleta o range de strings

                let frag = document.createDocumentFragment();
                //cria um fragmento de documento

                frag.appendChild(img);
                //adiciona conteudo a esse framento

                range.insertNode(frag);
                //range.insertNode() inserte o fragmento de documento dentro do range especificado

                range.setStartAfter(img);
                //Define a posição inicial do intervalo atual para a posição final do nó especificado.

                this.el.inputText.dispatchEvent(new Event('keyup'));
                // usando o new Event() disparamos o evento que quesermos
            });
        });
    ...
    startRecordMicrophoneTime() {
        ...
        this._countTimeRecord = setInterval(() => {
